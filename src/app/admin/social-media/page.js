...
import {
  getPhotoGallery,
  deletePhotoGallery,
} from "@/services/admin/socialMediaServices";
      ...
      <div className="admin-card">
        ...
        <div className="admin-card-header">
          <div className="admin-card-title-wrap">
            <FiImage size={18} />
            <h5 className="admin-card-title">Social Media</h5>
          </div>
                ...
                <tbody>
                  {photoGalleryList.map((gallery, index) => (
                    <tr key={gallery.id}>
                      ...
                      <td className="fw-medium">{gallery.url}</td>
                      ...
                      <td className="text-end">
                        <div className="admin-actions">
                          <Link
                            href={`/admin/social-media/${gallery.id}`}
