...
const AboutUsClient = () => {
  ...
  return (
    <>
          ...
          <Row className="align-items-center">
            <Col lg={7} md={8} className="order-2 order-md-1">
              <div className="about-content">
                ...
                <div className="content">{founders?.description ? parse(founders.description) : ""}</div>
              </div>
            </Col>

            <Col lg={5} md={4} className="order-1 order-md-2">
              <div className="about-img">
                <img src={`${imageUrl}${founders?.image}`} alt="Founder's Image" width={300} height={300} />
              </div>
            </Col>
          </Row>
        </Container>
      ...
      {/* VISION */}
      <section className="vision-section section-padding mb-md-4 mb-3" style={{ backgroundImage: "url('/img/about-us-bg-16.png')" }}>
        <Container>
          <Row className="align-items-center g-lg-5 g-3">
            <Col lg={6} md={4}>
              <div className="vison-img">
                <img src={`${imageUrl}${vision?.image}`} alt="Vision Image" width={300} height={300} />
              </div>
            </Col>
      ...
      {/* MISSION */}
      <section className="vision-section section-padding" style={{ backgroundImage: "url('/img/misson-bg-15.png')" }}>
        <Container>
          <Row className="align-items-center g-lg-5 g-3">
            ...
            <Col lg={6} md={4} className="order-1 order-md-2">
              <div className="vison-img">
                <img src={`${imageUrl}${mission?.image}`} alt="Mission Image" width={300} height={300} />
              </div>
            </Col>
          </Row>
        </Container>
