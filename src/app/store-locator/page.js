        ...
        <Container>
          ...
          <div className="store-locator-header">
            ...
            <Row className="align-items-center">
              ...
              <Col lg={3} md={6} sm={12}>
                <label className="store-locator-label">Select Stream</label>
              ...
              <Col lg={3} md={6} sm={12}>
                <label className="store-locator-label">Select Course</label>
                <select className="store-locator-select" defaultValue="Commerce-TYBCom">
                  <option>Commerce-TYBCom</option>
                  <option>Science-BSc</option>
                </select>
              </Col>
            </Row>
          </div>
          ...
          <Row className="store-locator-result">
            <Col lg={12}>
              ...
              <div className="store-locator-total">Total Records Found : <strong>5</strong></div>
